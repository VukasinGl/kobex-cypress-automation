...
import { syskorMkaPageBL } from "../../modules/BL/syskorBL/syskorMkaPageBL";

describe("Testing syskor mka page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the syskor mka page", () => {
    syskorMkaPageBL.assertSyskorMkaPage();
  });
