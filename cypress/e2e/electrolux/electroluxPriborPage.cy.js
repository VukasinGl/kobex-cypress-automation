...
import { electroluxPriborPageBL } from "../../modules/BL/electroluxBL/electroluxPriborPageBL";

describe("Testing electrolux pribor page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the electrolux pribor page", () => {
    electroluxPriborPageBL.assertElectroluxPriborPage();
  });
