...
import { electroluxAspiratoriPageBL } from "../../modules/BL/electroluxBL/electroluxAspiratoriPageBL";

describe("Testing electrolux aspiratori page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the electrolux aspiratori page", () => {
    electroluxAspiratoriPageBL.assertElectroluxAspiratoriPage();
  });
