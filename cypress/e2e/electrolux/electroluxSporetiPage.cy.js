...
import { electroluxSporetiPageBL } from "../../modules/BL/electroluxBL/electroluxSporetiPageBL";

describe("Testing electrolux sporeti page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the electrolux sporeti page", () => {
    electroluxSporetiPageBL.assertElectroluxSporetiPage();
  });
