...
import { electroluxMkaPageBL } from "../../modules/BL/electroluxBL/electroluxMkaPageBL";

describe("Testing electrolux mka page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the electrolux mka page", () => {
    electroluxMkaPageBL.assertElectroluxMkaPage();
  });
