...
import { electroluxFrizideriPageBL } from "../../modules/BL/electroluxBL/electroluxFrizideriPageBL";

describe("Testing electrolux frizideri page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the electrolux frizideri page", () => {
    electroluxFrizideriPageBL.assertElectroluxFrizideriPage();
  });
