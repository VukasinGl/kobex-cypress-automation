...
import { blancoPriborBL } from "../../modules/BL/blancoBL/blancoPriborPageBL";

describe("Testing blanco priborr page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the blanco pribor page", () => {
    blancoPriborBL.assertBlancoPriborPage();
  });
