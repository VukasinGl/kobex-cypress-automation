...
import { blancoDozerBL } from "../../modules/BL/blancoBL/blancoDozerPageBL";

describe("Testing blanco dozer page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the blanco dozer page", () => {
    blancoDozerBL.assertBlancoDozerPage();
  });
