...
import { tekaRernePageBL } from "../../modules/BL/tekaBL/tekaRernePageBL";

describe("Testing teka rerne page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the teka rerne page", () => {
    tekaRernePageBL.assertTekaRernePage();
  });
