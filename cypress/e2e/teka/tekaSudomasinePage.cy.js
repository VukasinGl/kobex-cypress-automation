...
import { tekaSudomasinePageBL } from "../../modules/BL/tekaBL/tekaSudomasinePageBL";

describe("Testing teka sudomasine page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the teka sudomasine page", () => {
    tekaSudomasinePageBL.assertTekaSudomasinePage();
  });
