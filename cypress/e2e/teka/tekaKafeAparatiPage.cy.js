...
import { tekaKafeAparatiPageBL } from "../../modules/BL/tekaBL/tekaKafeAparatiPageBL";

describe("Testing teka kafe aparati page UI", () => {
  before(() => {
    cy.visit(`${Cypress.env("baseUrl")}`);
  });

  it("Assert all the elements on the teka kafe aparati page", () => {
    tekaKafeAparatiPageBL.assertTekaKafeAparatiPage();
  });
